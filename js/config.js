...
var Config = {
    ...
    WAVES: [
        ...
        { number: 39, enemies: [{ type: 'heavy_tank', count: 5 }, { type: 'nullifier', count: 4 }, { type: 'swarm', count: 35 }, { type: 'home_wrecker', count: 4 }, { type: 'emp_drone', count: 6 }, { type: 'zapper', count: 12 }, { type: 'plasma_parasite', count: 6 }, { type: 'flying_bomber', count: 2 }], spawnDelay: 130, spawnPoints: 4 },
        ...
        { number: 50, enemies: [{ type: 'overload_boss', count: 5 }, { type: 'siege_engine', count: 6 }, { type: 'heavy_tank', count: 6 }, { type: 'phase_walker', count: 8 }, { type: 'bomber', count: 10 }, { type: 'swarm', count: 50 }, { type: 'nullifier', count: 5 }, { type: 'disruptor', count: 5 }, { type: 'home_wrecker', count: 5 }, { type: 'drill_worm', count: 5 }, { type: 'leech', count: 5 }, { type: 'river_serpent', count: 6 }, { type: 'runner', count: 15 }, { type: 'tunneler', count: 8 }, { type: 'heavy_flyer', count: 4 }, { type: 'zapper', count: 15 }, { type: 'plasma_parasite', count: 10 }, { type: 'emp_sniper', count: 6 }, { type: 'flying_bomber', count: 4 }], spawnDelay: 60, spawnPoints: 4 }
    ],
