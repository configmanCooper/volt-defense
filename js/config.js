...
var Config = {
    ...
    BUILDINGS: {
        ...
        mine_layer: {
            ...
            range: 200,
            upgradeTo: null,
            description: 'Deploys up to 10 proximity mines in a circle. Each mine takes 24s and 3 steel to generate. Mines deal 150 splash damage in 90px radius.',
            icon: '💣'
        },
        autocannon: {
            name: 'Autocannon',
            ...
            projectileSpeed: 500,
            upgradeTo: null,
            description: 'Fast-firing ballistic weapon. 30 dmg every 0.2s. Consumes 1 steel per 5 shots.',
            icon: '🔫'
        },
        ...
        plasma_cannon: {
            ...
            armorBypass: 1.0,
            upgradeTo: null,
            description: 'Fires superheated plasma bolts that ignore all enemy armor. Uses 1 uranium per 2 shots.',
            icon: '🔮'
        },
        fusion_beam: {
            name: 'Fusion Beam',
    ...
    ENEMIES: {
        ...
        river_serpent: {
            ...
            special: 'river_spawn',
            firstWave: 6,
            description: 'An aquatic predator that spawns directly from rivers on the map, preferring rivers near your buildings. River Serpents stay within waterways as long as possible, slithering at high speed toward vulnerable structures along the riverbanks. They only leave the water when no river path exists to their target. Especially dangerous to hydro plants and any buildings near rivers. Place weapons near river paths to intercept them. Spawns from rivers — prefers water paths.'
        },
        home_wrecker: {
            name: 'Home Wrecker',
            hp: 150,
        ...
        flying_bomber: {
            ...
            attackCooldown: 10,
            firstWave: 33,
            description: 'A massive aerial bomber that flies directly toward the core. When it passes over a building, it stops and drops bombs every 10 seconds dealing 20 damage. Once the building is destroyed, it resumes course. If it reaches the core, it hovers above it dropping bombs that deal 5 core damage every 10 seconds. Unlike other flying enemies, it does not destroy itself — it must be shot down. Flying enemy — ignores walls, stops to bomb buildings.'
        },
        emp_sniper: {
            name: 'EMP Sniper',
            hp: 90,
        ...
        mirror_sentinel: {
            ...
            reflectDPS: 1,
            firstWave: 22,
            description: 'A shimmering armored unit that projects a reflective energy shield. Lasers and blasters that target a Mirror Sentinel have their beams reflected back, dealing 1 damage per second to the attacking building. Use missiles, autocannons, or other non-beam weapons to take them down safely. Medium HP and slow speed give you time to react. Reflects laser and blaster damage back at attackers.'
        },
        swarm_mother: {
            name: 'Swarm Mother',
            hp: 6000,
    ...
    WAVES: [
        ...
        { number: 6, enemies: [{ type: 'shielded_grunt', count: 3 }, { type: 'river_serpent', count: 2 }, { type: 'grunt', count: 4 }], spawnDelay: 500, spawnPoints: 1 },
        // Wave 7: Wall Breakers arrive
        { number: 7, enemies: [{ type: 'wall_breaker', count: 2 }, { type: 'grunt', count: 6 }, { type: 'runner', count: 5 }, { type: 'shielded_grunt', count: 3 }, { type: 'bomber', count: 2 }], spawnDelay: 450, spawnPoints: 1 },
        // Wave 8: Home Wreckers arrive (target housing)
        { number: 8, enemies: [{ type: 'home_wrecker', count: 2 }, { type: 'grunt', count: 4 }, { type: 'shielded_grunt', count: 2 }, { type: 'river_serpent', count: 2 }, { type: 'runner', count: 4 }], spawnDelay: 450, spawnPoints: 2 },
        // Wave 9
        ...
        // Wave 11
        { number: 11, enemies: [{ type: 'tank', count: 1 }, { type: 'wall_breaker', count: 2 }, { type: 'bomber', count: 4 }, { type: 'home_wrecker', count: 3 }, { type: 'shielded_grunt', count: 5 }, { type: 'drill_worm', count: 3 }], spawnDelay: 380, spawnPoints: 2 },
        ...
        { number: 15, enemies: [{ type: 'tunneler', count: 4 }, { type: 'tank', count: 3 }, { type: 'leech', count: 4 }, { type: 'bomber', count: 5 }, { type: 'home_wrecker', count: 3 }, { type: 'river_serpent', count: 4 }], spawnDelay: 340, spawnPoints: 2 },
        // Wave 16: Swarms unleashed
        { number: 16, enemies: [{ type: 'swarm', count: 30 }, { type: 'disruptor', count: 3 }, { type: 'drill_worm', count: 3 }, { type: 'emp_drone', count: 4 }, { type: 'wall_breaker', count: 4 }, { type: 'runner', count: 8 }], spawnDelay: 300, spawnPoints: 2 },
        // Wave 17
        ...
        { number: 20, enemies: [{ type: 'overload_boss', count: 1 }, { type: 'heavy_tank', count: 2 }, { type: 'heavy_flyer', count: 2 }, { type: 'shielded_grunt', count: 10 }, { type: 'swarm', count: 18 }, { type: 'nullifier', count: 3 }], spawnDelay: 250, spawnPoints: 3 },
        ...
        { number: 22, enemies: [{ type: 'heavy_tank', count: 2 }, { type: 'wall_breaker', count: 10 }, { type: 'nullifier', count: 4 }, { type: 'scout_drone', count: 6 }, { type: 'tunneler', count: 3 }, { type: 'drill_worm', count: 3 }, { type: 'swarm', count: 20 }, { type: 'river_serpent', count: 3 }, { type: 'mirror_sentinel', count: 3 }], spawnDelay: 240, spawnPoints: 3 },
        ...
        { number: 24, enemies: [{ type: 'tank', count: 5 }, { type: 'swarm', count: 85 }, { type: 'disruptor', count: 3 }, { type: 'emp_drone', count: 4 }, { type: 'mirror_sentinel', count: 4 }], spawnDelay: 220, spawnPoints: 3 },
        { number: 25, enemies: [{ type: 'saboteur', count: 3 }, { type: 'heavy_tank', count: 2 }, { type: 'nullifier', count: 2 }, { type: 'drill_worm', count: 3 }, { type: 'swarm', count: 15 }, { type: 'plasma_parasite', count: 6 }, { type: 'zapper', count: 8 }, { type: 'mirror_sentinel', count: 3 }], spawnDelay: 210, spawnPoints: 3 },
        ...
        { number: 29, enemies: [{ type: 'heavy_tank', count: 3 }, { type: 'home_wrecker', count: 4 }, { type: 'swarm', count: 30 }, { type: 'nullifier', count: 3 }, { type: 'saboteur', count: 3 }, { type: 'emp_sniper', count: 3 }, { type: 'plasma_parasite', count: 5 }, { type: 'mirror_sentinel', count: 4 }], spawnDelay: 180, spawnPoints: 3 },
        { number: 30, enemies: [{ type: 'swarm_mother', count: 1 }, { type: 'overload_boss', count: 1 }, { type: 'siege_engine', count: 1 }, { type: 'heavy_tank', count: 2 }, { type: 'bomber', count: 5 }, { type: 'disruptor', count: 3 }, { type: 'swarm', count: 20 }, { type: 'river_serpent', count: 4 }, { type: 'tunneler', count: 8 }, { type: 'emp_drone', count: 10 }, { type: 'wall_breaker', count: 5 }, { type: 'mirror_sentinel', count: 5 }], spawnDelay: 170, spawnPoints: 4 },
        { number: 31, enemies: [{ type: 'siege_engine', count: 1 }, { type: 'saboteur', count: 5 }, { type: 'nullifier', count: 3 }, { type: 'home_wrecker', count: 3 }, { type: 'emp_drone', count: 5 }, { type: 'zapper', count: 8 }, { type: 'emp_sniper', count: 3 }, { type: 'mirror_sentinel', count: 3 }], spawnDelay: 170, spawnPoints: 4 },
        ...
        { number: 33, enemies: [{ type: 'siege_engine', count: 2 }, { type: 'disruptor', count: 4 }, { type: 'nullifier', count: 3 }, { type: 'bomber', count: 6 }, { type: 'river_serpent', count: 5 }, { type: 'plasma_parasite', count: 6 }, { type: 'zapper', count: 8 }, { type: 'flying_bomber', count: 1 }], spawnDelay: 160, spawnPoints: 4 },
        ...
        { number: 36, enemies: [{ type: 'heavy_tank', count: 5 }, { type: 'bomber', count: 8 }, { type: 'home_wrecker', count: 4 }, { type: 'leech', count: 4 }, { type: 'river_serpent', count: 5 }, { type: 'swarm', count: 20 }, { type: 'tunneler', count: 6 }, { type: 'nullifier', count: 5 }, { type: 'flying_bomber', count: 2 }], spawnDelay: 140, spawnPoints: 4 },
        { number: 37, enemies: [{ type: 'siege_engine', count: 2 }, { type: 'tank', count: 6 }, { type: 'swarm', count: 30 }, { type: 'disruptor', count: 4 }, { type: 'nullifier', count: 3 }, { type: 'plasma_parasite', count: 8 }, { type: 'emp_sniper', count: 4 }, { type: 'mirror_sentinel', count: 4 }], spawnDelay: 140, spawnPoints: 4 },
        ...
        { number: 39, enemies: [{ type: 'heavy_tank', count: 5 }, { type: 'nullifier', count: 4 }, { type: 'swarm', count: 35 }, { type: 'home_wrecker', count: 4 }, { type: 'emp_drone', count: 6 }, { type: 'zapper', count: 12 }, { type: 'plasma_parasite', count: 6 }, { type: 'flying_bomber', count: 2 }, { type: 'mirror_sentinel', count: 4 }], spawnDelay: 130, spawnPoints: 4 },
        // Wave 40: Phase Walkers + Procedural Boss
        { number: 40, enemies: [{ type: 'quake_titan', count: 1 }, { type: 'overload_boss', count: 1 }, { type: 'swarm_mother', count: 1 }, { type: 'phase_walker', count: 3 }, { type: 'siege_engine', count: 2 }, { type: 'heavy_tank', count: 3 }, { type: 'disruptor', count: 4 }, { type: 'swarm', count: 25 }, { type: 'river_serpent', count: 5 }, { type: 'tunneler', count: 6 }, { type: 'wall_breaker', count: 5 }, { type: 'leech', count: 12 }, { type: 'mirror_sentinel', count: 5 }], spawnDelay: 120, spawnPoints: 4 },
        ...
        { number: 42, enemies: [{ type: 'siege_engine', count: 3 }, { type: 'phase_walker', count: 3 }, { type: 'swarm', count: 40 }, { type: 'drill_worm', count: 4 }, { type: 'home_wrecker', count: 4 }, { type: 'bomber', count: 8 }, { type: 'nullifier', count: 5 }, { type: 'heavy_tank', count: 4 }, { type: 'flying_bomber', count: 2 }], spawnDelay: 110, spawnPoints: 4 },
        ...
        { number: 45, enemies: [{ type: 'siege_engine', count: 4 }, { type: 'phase_walker', count: 5 }, { type: 'drill_worm', count: 5 }, { type: 'home_wrecker', count: 5 }, { type: 'saboteur', count: 5 }, { type: 'river_serpent', count: 6 }, { type: 'emp_sniper', count: 5 }, { type: 'zapper', count: 12 }, { type: 'flying_bomber', count: 3 }], spawnDelay: 100, spawnPoints: 4 },
        ...
        { number: 48, enemies: [{ type: 'siege_engine', count: 5 }, { type: 'phase_walker', count: 6 }, { type: 'bomber', count: 10 }, { type: 'home_wrecker', count: 5 }, { type: 'drill_worm', count: 5 }, { type: 'swarm', count: 25 }, { type: 'heavy_tank', count: 4 }, { type: 'tunneler', count: 6 }, { type: 'flying_bomber', count: 3 }], spawnDelay: 80, spawnPoints: 4 },
        ...
        { number: 50, enemies: [{ type: 'the_nexus', count: 1 }, { type: 'overload_boss', count: 1 }, { type: 'swarm_mother', count: 1 }, { type: 'quake_titan', count: 1 }, { type: 'siege_engine', count: 6 }, { type: 'heavy_tank', count: 6 }, { type: 'phase_walker', count: 8 }, { type: 'bomber', count: 10 }, { type: 'swarm', count: 50 }, { type: 'nullifier', count: 5 }, { type: 'disruptor', count: 5 }, { type: 'home_wrecker', count: 5 }, { type: 'drill_worm', count: 5 }, { type: 'leech', count: 5 }, { type: 'river_serpent', count: 6 }, { type: 'runner', count: 15 }, { type: 'tunneler', count: 8 }, { type: 'heavy_flyer', count: 4 }, { type: 'zapper', count: 15 }, { type: 'plasma_parasite', count: 10 }, { type: 'emp_sniper', count: 6 }, { type: 'flying_bomber', count: 4 }, { type: 'mirror_sentinel', count: 6 }], spawnDelay: 60, spawnPoints: 4 }
    ],
    ...
    DIFFICULTY: {
        ...
        lightning: {
            ...
            enemySpeedMult: 1.1,
            buildingCostMult: 1.25,
            buildingEnergyMult: 1.1,
            waveInterval: 60,
            firstWaveDelay: 120,
            killRewardMult: 1.0,
            waveBonusMult: 1.0,
