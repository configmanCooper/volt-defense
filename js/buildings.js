    ...
    return {
        ...
        place: function(typeKey, gridX, gridY, forcePlace) {
            ...
            var building = {
                ...
                reloadTimer: 0,
                // Shield-specific
                shieldHP: Math.floor((def.shieldHP || 0) * 0.1),
        ...
        getSerializableState: function() {
            ...
            for (var i = 0; i < _buildings.length; i++) {
                ...
                buildingData.push({
                    ...
                    gridX: b.gridX,
                    gridY: b.gridY,
                    hp: (b.hp != null && b.hp === b.hp) ? b.hp : (b.maxHp || 100),
                    maxHp: b.maxHp || 100,
                    energy: b.energy,
                    active: b.active,
                    target: null,
                    ...
                    scaledStorageCapacity: b.scaledStorageCapacity || 0,
            ...
            if (data.buildings && data.buildings.length) {
                for (i = 0; i < data.buildings.length; i++) {
                    ...
                    var building = {
                        ...
                        hp: (saved.hp != null && saved.hp === saved.hp) ? saved.hp : (saved.maxHp || (def && def.hp ? def.hp : 100)),
                        maxHp: saved.maxHp || (def && def.hp ? def.hp : 100),
                        ...
                        scaledStorageCapacity: saved.scaledStorageCapacity || 0,
                        depositRef: null,
